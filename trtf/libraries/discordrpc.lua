...
if love.system.getOS() == "Windows" then
  discordRPClib = ffi.load(love.filesystem.getSaveDirectory() .. "/bin/discord-rpc.dll")
elseif love.system.getOS() == "Linux" then
  discordRPClib = ffi.load(love.filesystem.getSaveDirectory() .. "/bin/libdiscord-rpc.so")
end
