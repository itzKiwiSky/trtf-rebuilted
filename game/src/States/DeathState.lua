...
function DeathState:enter()
    ...
    self.blurFX.gaussianblur.sigma = 10
    ...
    self.gitems = {
        {
            ...
            hitbox = {},
            action = function()
                LoadingState.mode = self.secretNight and "secret" or "normal"
