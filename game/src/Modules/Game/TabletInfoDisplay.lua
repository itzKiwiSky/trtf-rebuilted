...
return function(this)
    ...
    love.graphics.print(languageService["game_energy"]:format(NightState.officeState.power.powerDisplay), fnt_camError, 64, love.graphics.getHeight() - 174)
    ...
    if tabletCameraSubState.camID == "vent_kitty" then
        love.graphics.print(NightState.officeState.vent.left and languageService["game_vent_state_closed"] or languageService["game_vent_state_open"], fnt_camError, 64, love.graphics.getHeight() - 204)
    elseif tabletCameraSubState.camID == "vent_sugar" then
        love.graphics.print(NightState.officeState.vent.right and languageService["game_vent_state_closed"] or languageService["game_vent_state_open"], fnt_camError, 64, love.graphics.getHeight() - 204)
    end
    ...
    drawQueue(64, love.graphics.getHeight() - 110, 128, 48, NightState.officeState.power.powerQueue, 7, 5, 5, {0, 255, 0}, {255, 0, 0})
