    ...
    if PuppetAI.released then
        ...
        if PuppetAI.musicBoxTimer >= 1 then
            ...
            if PuppetAI.timer >= 7.3 then
                ...
                if PuppetAI.move <= NightState.animatronicsAI.puppet and NightState.animatronicsAI.puppet > 0 and not NightState.officeState.hasAnimatronicInOffice then
            ...
            if PuppetAI.patience >= 150 then
                if not NightState.killed then
                    ...
                    NightState.jumpscareController.id = "puppet"
